import { ChartArea, ChevronRight, FileText } from "lucide-react";
import Link from "next/link";
import { CoAForm } from "./components/form";

export default async function CoACreate() {
  return (
        ...
        <div className="flex flex-col items-start space-y-1">
          <div className="flex items-center gap-3">
            <div className="p-3 bg-green-100 rounded-lg">
              <ChartArea className="text-primary w-6 h-6" />
            </div>
